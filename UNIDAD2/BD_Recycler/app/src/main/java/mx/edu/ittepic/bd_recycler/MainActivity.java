package mx.edu.ittepic.bd_recycler;
...
import mx.edu.ittepic.bd_recycler.entidades.Usuario;
import mx.edu.ittepic.bd_recycler.utilidades.Utilidades;
...
public class MainActivity extends AppCompatActivity {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.imageButton:
                    ...
                    if (registros == -1) {
                        Toast.makeText(MainActivity.this, "NO HAY NINGUNA FILA ", Toast.LENGTH_SHORT).show();

                    } else {
                        Toast.makeText(MainActivity.this, "AGREGA ALGUNA FILA " + registros, Toast.LENGTH_SHORT).show();
                    }

                case R.id.imageButton4:
                    Toast.makeText(MainActivity.this, "TODA LA LISTA", Toast.LENGTH_SHORT).show();
                    listardatos();
                    break;
            }
        }
    ...
    private void listardatos() {
        try {
            // se guarda la base de datos y se guarda en cursor para despues acomodarla en nuestro cardview
            listaUsuarios = new ArrayList<>();
            StringBuffer datos = new StringBuffer();
            Cursor cursor = con.getAll();//CREACION DEL CURSOR
    ...
    public Long registrarUsuario() {
        //realiza la insercion de la base de datos
