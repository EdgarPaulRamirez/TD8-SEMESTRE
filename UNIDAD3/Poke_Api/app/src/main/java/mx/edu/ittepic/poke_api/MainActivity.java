package mx.edu.ittepic.poke_api;
...
import mx.edu.ittepic.poke_api.Model.Pokemon;
...
public class MainActivity extends Activity {
    ...
    private final Response.Listener<String> onPokemonLoaded = new Response.Listener<String>() {
        ...
        public void onResponse(String response) {
            ...
            Toast.makeText(MainActivity.this, "CARGANDO..."+pokemon.getSprites().getFrontDefault(), Toast.LENGTH_SHORT).show();
    ...
    private final Response.ErrorListener onPokemonError = new Response.ErrorListener() {
        ...
        public void onErrorResponse(VolleyError error) {
            ...
            Toast.makeText(MainActivity.this, "CARGANDO....."+error.toString(), Toast.LENGTH_SHORT).show();
            progressBar.setVisibility(ProgressBar.GONE);
            //callPokemon();
        }
    };
